...
class Font extends PartialFont {
  ...
  constructor(family : string, style : string, weight : string, size : number | string = Font.DEFAULT_FONT_SIZE) {
    super(family, style, weight)
    this.size = size;
  }

  public static fromPartialFont(partialFont : PartialFont, size : number | string = Font.DEFAULT_FONT_SIZE) : Font {
